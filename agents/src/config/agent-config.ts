...
export const validationAgentDef: ETFAgentDefinition = {
...
export const koreanModificationAgentDef: ETFAgentDefinition = {
...
export const usModificationAgentDef: ETFAgentDefinition = {
  name: 'us-modifier',
...
export const marketModificationAgentDef: ETFAgentDefinition = {
