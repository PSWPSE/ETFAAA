...
export function parseUSNumber(value: string): number {
  if (!value) return 0;
...
export const KOREAN_ETF_SOURCE: DataSourceConfig = {
  type: 'korean-etf',
...
export const US_ETF_SOURCE: DataSourceConfig = {
  type: 'us-etf',
...
// 시장 지수 데이터 소스
export const INDICES_SOURCE: DataSourceConfig = {
  type: 'indices',
  name: 'Market Indices',
  nameKo: '시장 지수',
  baseUrl: 'https://finance.yahoo.com',
...
// 환율 데이터 소스 (네이버 금융)
export const FOREX_SOURCE: DataSourceConfig = {
  type: 'forex',
  name: 'Forex Rates',
  nameKo: '환율',
...
export const COMMODITIES_SOURCE: DataSourceConfig = {
  type: 'commodities',
  name: 'Commodities',
  nameKo: '원자재',
  baseUrl: 'https://finance.yahoo.com',
...
// 데이터 소스별 URL 생성
export function getItemUrl(source: DataSourceType, ticker: string): string {
