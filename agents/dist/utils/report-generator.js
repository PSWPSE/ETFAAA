...
export function generatePreValidationReport(report) {
    const lines = [];
...
export function generateFinalValidationReport(report) {
    const lines = [];
...
// Modification 리포트 생성
export function generateModificationReport(dataSource, date, modifications) {
    const lines = [];
...
// 일일 태스크 문서 생성
export function generateDailyTaskDocument(date, dataSourceReports, totalDurationMs) {
    const lines = [];
